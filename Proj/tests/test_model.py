...
def test_single_doc(keyphrase_length, vectorizer, base_keybert):
    ...
    keywords = base_keybert.extract_keywords(
        doc_one,
...
def test_extract_keywords_single_doc(
    keyphrase_length, mmr, maxsum, vectorizer, base_keybert
):
    """Test extraction of protected single document method"""
    top_n = 5
    keywords = base_keybert._extract_keywords_single_doc(
        doc_one,
        top_n=top_n,
        keyphrase_ngram_range=keyphrase_length,
        use_mmr=mmr,
...
def test_extract_keywords_multiple_docs(keyphrase_length, base_keybert):
    ...
    top_n = 5
    keywords_list = base_keybert._extract_keywords_multiple_docs(
